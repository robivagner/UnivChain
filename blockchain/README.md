...
**UnivChain** leverages a sophisticated **Hub-and-Spoke architecture** to seamlessly handle student enrollment, secure fee payments, transparent grade tracking, and the cryptographic issuance of a **Soulbound diploma** (student enrollment is tracked in contract storage).
...
* **StudentRegistry (Identity Spoke):** Manages live enrollment statuses and student record metadata in contract storage.
